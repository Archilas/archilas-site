...
- Hero video: if `public/hero-demo.mp4` or `NEXT_PUBLIC_HERO_DEMO_URL` exists, the hero plate loops a muted autoplay `<video>` (playsinline, no controls). Otherwise the coming-soon frame stays.
