...
export const HERO_STATUS_SEARCH = "Retrieving…";
export const HERO_STATUS_SELECT = "Ranking…";
...
export const HERO_RESULT = [
  { id: "pref", kind: "Preference", text: "Cap annual plans at 20% discount" },
  { id: "dec", kind: "Decision", text: "Enterprise floor stays $12k" },
  { id: "open", kind: "Open loop", text: "Legal still reviewing usage add-on" },
] as const;

export const HERO_STEPS = [
  { id: "retrieve", label: "Retrieve from living memory (already compacted)" },
  { id: "rank", label: "Rank prefs / decisions / open loops" },
  { id: "return", label: "Return context to model" },
] as const;
...
export const HERO_RESULT_AT = 10800;
